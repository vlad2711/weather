...
class TimelineAdapter(val weather: Weather): RecyclerView.Adapter<TimelineAdapter.Hodler>() {
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int) = Hodler(LayoutInflater.from(p0.context).inflate(R.layout.timeline_item, p0, false))

    override fun getItemCount() = weather.hourly.size

    override fun onBindViewHolder(p0: Hodler, p1: Int) = p0.bind(weather.hourly[p1])


    class Hodler(view: View): RecyclerView.ViewHolder(view){
